...
<head>
    <title>CARRIER RATE & LOAD CONFIRMATION {{ $load->load_number }}</title>
...
<<<<<<< HEAD
                                ...
                                <tr>
                                    <td style="text-align:center;">
                                        <p>{{ $load->load_carrier }}</p>
                                    </td>
                                    <td style="text-align:center;">
                                        <p>@if($load->carrier_dot != null && $load->load_mc_no != null)
                                                {{ $load->carrier_dot }} / {{ $load->load_mc_no }}
                                            @elseif($load->carrier_dot != null)
                                                {{ $load->carrier_dot }}
                                            @elseif($load->load_mc_no != null)
                                                {{ $load->load_mc_no }}
                                            @endif</p>
                                    </td>
                                    <td style="text-align:center;">
                                        <p>{{ $load->load_carrier_phone }}</p>
                                    </td>
                                    <td style="text-align:center;">
...
>>>>>>> old-repo/master
                            ...
                            @php
                             ...
                             $consignees_contact = json_decode($load->load_consigneer_contact, true); // Decode JSON string for consignee contact info
                             ...
                             $consigneeDiscription = json_decode($load->load_consignee_discription,true);
                             @endphp
                             @php
                             $counter = 1;
                             @endphp
...
>>>>>>> old-repo/master
        ...
        <div class="content">
                        ...
                        <!-- <p><b> Carrier Fee:</b> ${{ $load->load_carrier_fee }} FSC Rate {{ $load->load_billing_fsc_rate }}% <b>TOTAL : {{ $load->load_final_carrier_fee }} </b></p> -->
                        @php
    $otherCharges = json_decode($load->carrier_load_other_charge, true);
@endphp
<!-- <p><b> Final Customer Charges:</b> ${{ $load->load_shipper_rate }} FSC Rate {{ $load->load_fsc_rate }}% <b>TOTAL : {{ $load->shipper_load_final_rate }} </b></p> -->
<p>
    <b>Final Carrier Charges:</b> ${{ $load->load_carrier_fee }} , FSC Rate : {{ $load->load_billing_fsc_rate }}% ,
    @if (!empty($otherCharges))
        ...
        @endforeach
    @endif
    <b>= TOTAL: ${{ $load->load_final_carrier_fee }}</b>
</p>

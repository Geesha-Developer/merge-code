                    ...
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $rc->adv_customer_credit_limit }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                    </table>
                    ...
                    <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            ...
                            <tbody>
                                @foreach($dashboard as $load)
                                    ...
                                    <tr>
                                        <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;"><a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('admin.load.edit', $load->id) }}">{{ $load->load_number }}</a></td>
                   ...
                   <div class="table-responsive">
                         <table class="table table-responsive table-bordered table-hover dataTable js-exportable table-responsive">
                            ...
                            <tbody>
                                ...
                                @endphp
                                <tr>
                                <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;"><a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('admin.load.edit', $log->id) }}">{{ $log->load_number }}</a></td>

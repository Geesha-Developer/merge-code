                        ...
                        <form method="POST" action="{{ route('admin.update.load', ['id' => $load->id]) }}" id="myFormLoad" enctype="multipart/form-data">
                            ...
                            @method('PUT')
                                    <div class="card-header p-0">
                                       <h3 class="title mt-0 text-left" style="font-size:13px;background: #263544;color:#fff;">Load Details</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <a href="{{ route('admin.shipper.rc.download.pdf', ['id' => $load->id]) }}" title="Customer RC" target="_blank"><i class="fas fa-file-pdf" aria-hidden="true"  style="color:red; font-size: 24px;"></i>
                                        </a>
                                     </h3>
                                        <div class="row">
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="other_charge">Customer Other Change &nbsp; <i
                                        ...
                                        <h3 class="title" style="font-size:13px;background: #263544;color:#fff;">Carrier
                                            <a href="{{ route('admin.rc.download.pdf', ['id' => $load->id]) }}" title="Carrier RC" target="_blank"><i class="fas fa-file-pdf" aria-hidden="true" style="color:red;font-size: 24px;"></i>
                                                </a>
                                        </h3>
                                        <div class="row">
                                            <div class="col-md-3">
                                    ...
                                    <table class="table table-bordered" id="shipperTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="vertical-align: middle;font-size: 12px;">Shipper <code>*</code></th>
                                                <th style="vertical-align: middle;font-size: 12px;">Shipper Location</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Shipper Appointment</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Commodity Type</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Commodity Name<code>*</code></th>
                                                <th style="vertical-align: middle;font-size: 12px;">Qty</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Weight (lbs)</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Value ($) <code>*</code></th>
                                                <th style="vertical-align: middle;font-size: 12px;">PO Numbers</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Contact</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Shipper Description</th>
                                                <th style="vertical-align: middle;font-size: 12px;">Shipper Notes</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr id="shipperRow{{ $key + 1 }}">
                                                ...
                                                <td >
                                                    <input class="form-control" tyle=" width: 131px;" name="load_shipper_contact{{ $key + 1 }}" type="number" value="{{ $shipperContact[$key]['shipping_contact'] ?? '' }}">
                                                </td>
                                                <td >
...
<div class="table-responsive">
    ...
    <table class="table table-bordered" id="consigneeTable">
        <thead>
            <tr>
                <th style="vertical-align: middle;font-size: 12px;">Sr. No</th>
                <th style="vertical-align: middle;font-size: 12px;">Consignee <code>*</code></th>
                <th style="vertical-align: middle;font-size: 12px;">Consignee Location</th>
                <th style="vertical-align: middle;font-size: 12px;">Consignee Appointment</th>
                <th style="vertical-align: middle;font-size: 12px;">Commodity Type</th>
                <th style="vertical-align: middle;font-size: 12px;">Commodity Name<code>*</code></th>
                <th style="vertical-align: middle;font-size: 12px;">Qty</th>
                <th style="vertical-align: middle;font-size: 12px;">Weight (lbs)</th>
                ...
                <th style="vertical-align: middle;font-size: 12px;">Contact</th>
                <th style="vertical-align: middle;font-size: 12px;">Consignee Description</th>
                <th style="vertical-align: middle;font-size: 12px;">Consignee Notes</th>
                <th style="vertical-align: middle;font-size: 12px;">Actions</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr id="consigneeRow{{ $key + 1 }}">
                ...
                <td >
                    <input class="form-control" style=" width: 87px;" name="load_consignee_qty_{{ $key + 1 }}" value="{{ $consigneeQty[$key]['consignee_qty'] ?? '' }}">
                </td>
                <td >
                    <input class="form-control" style=" width: 90px;" name="load_consignee_weight_{{ $key + 1 }}" type="number" value="{{ $consigneeWeight[$key]['consignee_weight'] ?? '' }}">
                </td>
                <td >
                    <input class="form-control" style=" width: 90px;" required name="load_consignee_value_{{ $key + 1 }}" type="number" value="{{ $consigneeValue[$key]['consignee_value'] ?? '' }}">
                </td>
                <td >
                    <input class="form-control" style=" width: 130px;" name="load_consignee_po_numbers_{{ $key + 1 }}" value="{{ $consigneePoNumber[$key]['consignee_po_number'] ?? '' }}">
                </td>
                <td >
                    <input class="form-control" style=" width: 131px;" name="load_consigneer_contact_{{ $key + 1 }}" type="number" value="{{ $consigneeContact[$key]['consignee_contact'] ?? '' }}">
                </td>
                <td >

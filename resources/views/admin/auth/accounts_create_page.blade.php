...
<section class="content">
   ...
   <div class="block-header">
        ...
        <div class="col-md-6 offset-md-3">
            <div class="form"
                style="box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 20px;background: #f1f3f4;margin: 16% 0;padding: 14px 25px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <div class="form"
                        style="box-shadow: 0 4px 18px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); border-radius: 20px;background: #f1f3f4;margin-top: 15%;margin-bottom: 15%;padding: 14px 25px;">
                        <div class="text-center">
                        </div>
                        <form action="{{ route('create.new.login') }}" id="registrationForm" method="post">
                            @csrf

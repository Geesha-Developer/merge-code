                        ...
                        <table class="table table-bordered table-hover dataTable js-exportable">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: #fff !important;">Customer Address</th>
                                    <th style="color: #fff !important;">Complete Billing Address</th>
                                    <th style="color: #fff !important;">Billing Email</th>
                                    <th style="color: #fff !important;">Customer Contact</th>
                                    <th style="color: #fff !important;">Telephone</th>
                                    <th style="color: #fff !important;">Ext.</th>
                                    <th style="color: #fff !important;">Fax</th>
                                    <th style="color: #fff !important;">Email</th>
                                    <th style="color: #fff !important;">Sales Rep (Cargo)</th>
                                    <th style="color: #fff !important;">Payment Terms</th>
                                    <th style="color: #fff !important;">Remaning Credit Limit</th>
...
<<<<<<< HEAD
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">
                                    @if($log->invoice_status == 'Paid Record' && $log->load_status == 'Delivered')
                                    Invoiced
                                @elseif($log->load_status == 'Delivered' && $log->invoice_status == 'Paid')
                                    Invoiced and Paid
                                @elseif($log->load_status == 'Completed' && empty($log->invoice_status))
                                    Completed
                                @elseif($log->load_status == 'Open' && empty($log->invoice_status))
                                    Open
                                @elseif($log->load_status == 'Unloading' && empty($log->invoice_status))
                                    Unloading
                                @else
                                    {{ $log->load_status }}
                                @endif
                                    </td>
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $log->customer_refrence_number }}</td>
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">
                                        {{ $log->created_at->setTimezone('America/New_York')->format('Y-m-d H:i:s') }}
                                    </td>
                                    ...
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $log->load_workorder }}</td>
                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $log->customer_refrence_number }}</td>
                                </tr>
                                @endforeach
                            </tbody>

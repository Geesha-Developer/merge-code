                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dynamic-data">
                                                        <a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('accounting.load.edit', $delivered->id) }}">
                                                    ...
                                                    <td class="dynamic-data">
                                                        ...
                                                        @endif
                                                        <textarea name="internal_notes" id="internal_notes_{{ $delivered->id }}" data-id="{{ $delivered->id }}" class="internal-notes" placeholder="Enter additional notes..."></textarea>
                                                    </td>
                                        ...
                                        <table class="table table-bordered table-hover js-basic-example dataTable no-footer">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dynamic-data">
                                                        <a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('accounting.load.edit', $completed->id) }}">
                                        ...
                                        <table class="table table-bordered table-hover js-basic-example dataTable no-footer">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dynamic-data"
                                                        style="padding: 7px 10px !important; vertical-align: middle !important;">
                                                        <a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('accounting.load.edit', $invoice->id) }}">
                                                            {{ $invoice->load_number }}
                                                        </a>
                                                    </td>
                                                    <td class="dynamic-data"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="dynamic-data"
                                                        ...
                                                        <a style="color: rgb(10 185 90) !important;font-weight: 700;" href="{{ route('accounting.load.edit', $record->id) }}">
                                                            {{ $record->load_number }}
                                                        </a>
                                                    </td>
                                                    <td class="dynamic-data"
                                                    ...
                                                    $remaining = max($shipperLoadFinalRate - $receivingAmount, 0);
                                                    @endphp
                                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $remaining }}</td>
                                                    <td class="dynamic-data" style="padding: 7px 10px !important; vertical-align: middle !important;">{{ $record->remaining_amount }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="subject" name="subject" placeholder="Enter subject" value="Invoice for load #1234(1234) Ref #123456" required style="font-size: 10px;">
                    </div>
                    <div class="form-group">
...
<script src="https://cdn.tiny.cloud/1/9w211gyerlel8kcerqkn2xckl73tb6wk7v3c1rn3yc95gjsi/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script src="https://cdn.jsdelivr.net/npm/flatpickr"></script>


<!-- <script>
    tinymce.init({
        selector: '#message',  // Replace with your selector for the textarea
...
$(document).ready(function () {
    ...
    $('a[data-toggle="modal"]').on('click', function () {
        var invoiceNumber = $(this).data('invoice-id');  // Get the invoice ID
        var loadNumber = $(this).data('load-number');    // Get the load number

        // Fetch the relevant documents and data for the modal
        $.ajax({
            url: '{{ route("fetch.invoice.details") }}' + '?invoice_number=' + invoiceNumber + '&load_number=' + loadNumber,
            type: 'GET',
            success: function (response) {
                // Populate the email recipient field
                $('#toEmail').val(response.userEmail);  // Populate user email from the response

                // Populate the subject if needed
                $('#subject').val(response.subject || '');  

                // Add the attachments dynamically with checkboxes
                $('#attachmentList').empty();  // Clear previous attachments

                if (response.attachments.length > 0) {
                    response.attachments.forEach(function (attachment) {
                        $('#attachmentList').append(
                            '<div>' +
                                '<input type="checkbox" name="selected_attachments[]" value="' + attachment.file_path + '">' + 
                                attachment.file_name +
                            '</div>'
                        );
                    });
                } else {
                    $('#attachmentList').append('<p>No attachments available for this invoice.</p>');
                }
            },
            error: function (xhr, status, error) {
...
$('#sendMailBtn').on('click', function () {
    ...
    $.ajax({
        ...
        error: function (xhr, status, error) {
            ...
            alert('Failed to send email. Please check console for more details.');  // Show error message
        }
    });
});
